...
df = pd.read_csv("C:/Users/Alejandro/Desktop/Data/AmrCount/Amr_Count.tsv", sep='\t')
...
new_df = pd.read_csv("C:/Users/Alejandro/Desktop/Data/TestingDataset.csv")

y_nclas = svm_classifier.predict(new_df['accession'])
